...
set -e
cd "$(dirname "$0")"
SUITES="tests/firmware.test.js tests/profiles.test.js tests/maestro.test.js tests/maestro-import.test.js tests/mstr-share.test.js tests/roundtrip.test.js tests/blocks-trace.test.js tests/cad.test.js tests/look-boards.test.js tests/wiring.test.js tests/select.test.js tests/music.test.js tests/track-ui.test.js tests/setup.test.js tests/sounds.test.js tests/build-config.test.js tests/rc.test.js tests/sequencer.test.js tests/sequencer-ui.test.js tests/puppet.test.js tests/cues.test.js tests/sketch.test.js tests/pcaseq.test.js tests/anzellan.test.js tests/mouse.test.js tests/chrome.test.js tests/keyboard.test.js tests/workspaces.test.js tests/kiosk.test.js tests/hw.test.js tests/builder.test.js"
