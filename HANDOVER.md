...
| Tests | **2062 passing** across 32 suites, both builds, zero failures — plus PCA Studio's 86-assertion smoke test (in `./test.sh`) and 87 host-compiled C++ assertions in `arduino/MaestroPCA/test`. v1.45.0 added 227 of them, every one written red first |
